...
describe "UI components utility", ->
    describe "creating a flyout component", ->
        anchorEl = null
        flyoutTemplate = -> "<div>My Flyout</div>"
        ...
        it "should implement the flyout component api", ->
            FlyoutComponent = createFlyoutConstructor(flyoutTemplate)
