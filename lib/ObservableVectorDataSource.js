...
ObservableVectorListDataAdapter.prototype = {
    ...
    _notifyInsertedAtIndex: function (index) {
        var previousKey = index === 0 ? null : this._keySelector(this._observableVector[index - 1]);
        this._notificationHandler.inserted(this._itemFromIndex(index), previousKey, null, index);
    },
    getCount: function () {
